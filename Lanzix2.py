...
user_no = ["no", "no way", "that's stupid", "why would i do that?", "that's really dumb", "nope", "i don't think so",
           "that won't fly"]
rand_good = ["knife", "health"]
rand_bad = ["Poison", "Killer interaction"]
            ...
            while True:
                ...
                if (choice_a.lower() == "2"):
                    ...
                    if (choice_plate1.lower() == "3"):
                        ...
                        # Remove pressure plate #3? We don't really need it and it woult be more to code!
                    # easter egg
                    if (choice_plate1.lower() == "4"):
                        ...
                        # time.sleep(3)
                        print("you look down at the wolf, surprised")
                        # time.sleep(3)
